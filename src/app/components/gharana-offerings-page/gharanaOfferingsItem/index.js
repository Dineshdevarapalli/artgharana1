...
import styles from './gharanaOfferingsItem.module.scss'

const GharanaOfferingsItem = ({val}) => {
    ...
    return (
        <>
            <button 
                className={styles.offering_item}
                onClick={() => SetPopup(val)}
            >
                <div className={styles.offering_item_image}>
                    <Image
                ...
                <div className={styles.offering_item_content}>
...
export default GharanaOfferingsItem